package com.weile.casualgames.view.widget.quickadapter;
 ...
 */
public abstract class EnhancedQuickAdapter<T> extends com.weile.casualgames.view.widget.quickadapter.QuickAdapter<T> {
