...
public class FollowFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (mView == null && inflater != null) {
            mView = inflater.inflate(R.layout.fragment_follow, null);
    ...
    public void initValue() {
        ...
        FansVo fansVo1 = new FansVo("风中的也百合2", "个性签名1", false);
        countlist.add(fansVo1);
        FansVo fansVo2 = new FansVo("风中的也百合2", "个性签名2", true);
        countlist.add(fansVo2);
        FansVo fansVo3 = new FansVo("风中的也百合2", "个性签名3", false);
        countlist.add(fansVo3);
        FansVo fansVo4 = new FansVo("风中的也百合2", "个性签名4", true);
        countlist.add(fansVo4);
        FansVo fansVo5 = new FansVo("风中的也百合2", "个性签名5", false);
