...
public class ImitateIphoneDialog extends Dialog implements OnClickListener{
	...
	public ImitateIphoneDialog(Context context){
	...
	@SuppressLint("InlinedApi") private View createView(){
	...
	public ImitateIphoneDialog setCancelButtonTitle(String title){
		this.cancelTitle = title;
		return this;
	}


	public ImitateIphoneDialog setCancelButtonTitle(int strId){
		return setCancelButtonTitle(mContext.getString(strId));
	}

	public ImitateIphoneDialog setCancelableOnTouchMenuOutside(boolean cancelable){
		mCancelableOnTouchOutside = cancelable;
		return this;
	}

	public ImitateIphoneDialog addItems(String... titles){
	...
	public ImitateIphoneDialog setItemClickListener(MenuItemClickListener listener){
